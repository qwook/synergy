...
void IpcClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IpcClient::readLogLine)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (IpcClient::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IpcClient::infoMessage)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (IpcClient::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IpcClient::errorMessage)) {
                *result = 2;
                return;
            }
        }
...
void *IpcClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IpcClient.stringdata0))
        return static_cast<void*>(const_cast< IpcClient*>(this));
