...
QT_MOC_LITERAL(3, 21, 48) // "on_m_pKeySequenceWidgetHotkey..."

    },
    "ActionDialog\0accept\0\0"
...
const QMetaObject ActionDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ActionDialog.data,
      qt_meta_data_ActionDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *ActionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ActionDialogBase"))
        return static_cast< Ui::ActionDialogBase*>(const_cast< ActionDialog*>(this));
