...
void WebClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WebClient *_t = static_cast<WebClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (WebClient::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WebClient::error)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject WebClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WebClient.data,
      qt_meta_data_WebClient,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void WebClient::error(QString _t1)
{
