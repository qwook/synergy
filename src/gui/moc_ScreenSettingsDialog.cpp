...
#include "src/ScreenSettingsDialog.h"
...
void *ScreenSettingsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScreenSettingsDialog.stringdata0))
        return static_cast<void*>(const_cast< ScreenSettingsDialog*>(this));
    if (!strcmp(_clname, "Ui::ScreenSettingsDialogBase"))
        return static_cast< Ui::ScreenSettingsDialogBase*>(const_cast< ScreenSettingsDialog*>(this));
